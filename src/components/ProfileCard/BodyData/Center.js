...
const BodyCenter = ({ card }) => {
  ...
  return (
    <>
      <div className="w-3/4 flex min-w-[120px] items-center pt-[43px] flex-col">
        ...
        {card.details.bio.length > 0 && (
          <div className="text-center opacity-70 mb-6 overflow-hidden text-xs max-w-full min-w-[10px] font-medium contacting-tight tracking-tighter">
